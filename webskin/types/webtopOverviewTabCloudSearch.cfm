...
<cfset qSearchTypes = application.fc.lib.cloudsearch.getAllContentTypes()>
<cfif listFind(valueList(qSearchTypes.contentType), stObj.typename)>
...
<cfelse>
	<cfoutput>This content type is not indexed in CloudSearch</cfoutput>
</cfif>
